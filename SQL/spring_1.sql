...
DROP TABLE tb_carrinho1 CASCADE CONSTRAINTS;
DROP TABLE tb_historico_venda1 CASCADE CONSTRAINTS;
DROP TABLE tb_produto1 CASCADE CONSTRAINTS;
DROP TABLE tb_modelo1 CASCADE CONSTRAINTS;
DROP TABLE tb_categoria1 CASCADE CONSTRAINTS;
DROP TABLE tb_marca1 CASCADE CONSTRAINTS;
DROP TABLE tb_backlog1 CASCADE CONSTRAINTS;
DROP TABLE tb_usuario1 CASCADE CONSTRAINTS;
DROP TABLE tb_empresa1 CASCADE CONSTRAINTS;
DROP TABLE tb_auditoria_produto1 CASCADE CONSTRAINTS;
...
--tabela de auditoria para a sprint 3
CREATE TABLE tb_auditoria_produto1 (
